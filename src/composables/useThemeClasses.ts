...
export const useThemeClasses = () => {
  ...
  const textClasses = computed(() => 'text-black dark:text-white')
  ...
  const iconInContainerClasses = computed(() => 'text-white dark:text-black')
  ...
  const priceTextClasses = computed(() => 'text-black dark:text-white font-semibold')
  ...
  const faqContentClasses = computed(() => 'px-6 pb-4 py-4 bg-white dark:bg-gray-900')
