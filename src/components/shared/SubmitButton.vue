<template>
  ...
  >
    <span v-if="loading" class="flex items-center justify-center" aria-label="Processing, please wait">
...
const buttonClasses = computed(() => [
  ...
  // Color variants
  {
    'bg-primary text-primary-foreground hover:bg-secondary focus:ring-2 focus:ring-primary/20 focus:ring-offset-2': props.variant === 'primary',
    'bg-secondary text-secondary-foreground hover:bg-accent focus:ring-2 focus:ring-secondary/20 focus:ring-offset-2': props.variant === 'secondary'
  },
