      ...
      >
        <div class="basis-auto text-center md:text-left lg:basis-[384px]">
          ...
          <div class="w-[295px] xl:w-full">
            <p class="font-srProDisplay text-base font-semibold">Location</p>
            ...
            <h4 class="font-srProDisplay text-base font-medium">Email:</h4>
            <p class="font-srProDisplay font-normal text-orange-400">webteam@tejontech.com</p>
          </div>
        </div>
        <div
        ...
        >
          <div class="max-w-[295px]">
            <h4 class="font-srProDisplay text-base font-medium">About Us</h4>
            <ul class="mt-2 font-srProDisplay text-sm font-light *:pb-2">
              <li>
                <router-link to="#" class="hover:text-orange-400 transition-colors"
          ...
          <div class="max-w-[295px]">
            <h4 class="font-srProDisplay text-base font-medium">Support</h4>
            <div
              class="mt-2 flex items-center justify-start rounded-2xl border border-gray-700 p-2"
            >
              ...
              <div class="px-3">
                <p class="font-srProDisplay text-sm font-thin text-gray-300">9AM - 8PM</p>
                <p class="font-srProDisplay font-semibold text-orange-400">16744</p>
              </div>
            </div>
          </div>
        </div>
